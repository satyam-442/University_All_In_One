...
public class Questions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar = (Toolbar) findViewById(R.id.questions_page_toolbar);
        setSupportActionBar(mToolbar);
        getSupportActionBar().setTitle("Questions");

        blogDrawerLayout =(DrawerLayout) findViewById(R.id.questions_drawer_layout);
        actionBarDrawerToggle = new ActionBarDrawerToggle(Questions.this,blogDrawerLayout,R.string.drawer_open,R.string.drawer_close);
